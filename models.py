...
class CycleGenerator(nn.Module):
    ...
    """
    def __init__(self, conv_dim=64, init_zero_weights=False, batch_norm=True):
        ...
        self.deconv1 = deconv(conv_dim * 2, conv_dim    , kernel_size=4, stride=2, padding=1, batch_norm=batch_norm)
        self.deconv2 = deconv(conv_dim    , 3           , kernel_size=4, stride=2, padding=1, batch_norm=False)
...
class WGANGPDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64):
        ...
        self.conv1 = conv(3, conv_dim, kernel_size=4, stride=2, padding=1, batch_norm=False, init_zero_weights=False)
        self.conv2 = conv(conv_dim, conv_dim*2, kernel_size=4, stride=2, padding=1, batch_norm=False, init_zero_weights=False)
        self.conv3 = conv(conv_dim*2, conv_dim*4, kernel_size=4, stride=2, padding=1, batch_norm=False, init_zero_weights=False)
        self.conv4 = conv(conv_dim*4, 1, kernel_size=4, stride=2, padding=0, batch_norm=False, init_zero_weights=False)
